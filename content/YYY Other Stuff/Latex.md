...
aliases:
  - ךשאקס
---
**IMPORTANT: to use snippets, turn off predictive text in samsung keyboard!**
...
| Trigger | Replacement | letter        | Trigger | Replacement | letter |
| ------- | ----------- | ------------- | ------- | ----------- | ------ |
...
- "O" will surround it with "\overbrace". $\overbrace{ x=1 }^{ wow }$
- "U" will surround it with "\underbrace". $\underbrace{ x=1 }_{ woah }$
- "C" will surround it with "\cancel". $\cancel{ x=1 }$
- "K" will surround it with "\cancelto". $\cancelto{ wow }{ x=1 }$
- "B" will surround it with "\underset". $\underset{ wow }{ x=1 }$
- L for color :)

# Colors
$$
1+\textcolor{red}{2}+\colorbox{lightgreen}{3}=6
$$
![[Pasted image 20250105105732.png|200]]
# Snippets
```
[
    // Math mode
    ...
    {trigger: "@ש", replacement: "\\alpha", options: "mA"},
    {trigger: "@נ", replacement: "\\beta", options: "mA"},
    {trigger: "@ע", replacement: "\\gamma", options: "mA"},
    {trigger: "@ג", replacement: "\\delta", options: "mA"},
    {trigger: "@ק", replacement: "\\epsilon", options: "mA"},
    {trigger: ":ק", replacement: "\\varepsilon", options: "mA"},
    {trigger: "@ז", replacement: "\\zeta", options: "mA"},
    {trigger: "@א", replacement: "\\theta", options: "mA"},
    {trigger: ":א", replacement: "\\vartheta", options: "mA"},
    {trigger: "@ן", replacement: "\\iota", options: "mA"},
    {trigger: "@ל", replacement: "\\kappa", options: "mA"},
    {trigger: "@ך", replacement: "\\lambda", options: "mA"},
    {trigger: "@ד", replacement: "\\sigma", options: "mA"},
    {trigger: "@ו", replacement: "\\upsilon", options: "mA"},
    {trigger: "@ם", replacement: "\\omega", options: "mA"},
    {trigger: "םצק", replacement: "\\omega", options: "mA"},
    {trigger: "Oצק", replacement: "\\Omega", options: "mA"},
    ...
    {trigger: "-\\to", replacement: "\\overrightarrow{$0}$1", options: "mA"},
	{trigger: "!>", replacement: "\\mapsto", options: "mA"},
    {trigger: "=>", replacement: "\\implies", options: "mA"},
	{trigger: "=<", replacement: "\\impliedby", options: "mA"},
    {trigger: "\\leq>", replacement: "\\iff", options: "mA"},
    ...
    {trigger: "sp", replacement: "sp\\left\\{ $0 \\right\\}$1", options: "mA"},
    ...
    // Visual operations
    {trigger: "col", replacement: "\\textcolor{${0:red}}{$1} $2", options: "mA"},
    {trigger: "L", replacement: "\\textcolor{${0:red}}{${VISUAL}} ", options: "mA"},
    ...
    // Brackets
	{trigger: "skl", replacement: "\\langle $0 | $1 \\rangle $2", options: "mA"},
